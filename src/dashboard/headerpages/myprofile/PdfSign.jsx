    ...
    <section className="pdf-sign">
      ...
      {!signatureMethod ? (
        <div className="signature-methods">
          ...
          <button onClick={() => handleMethodSelect("aadhaar")}>
            Aadhaar e-Sign
          </button>
          <button onClick={() => handleMethodSelect("canvas")}>
            Draw Signature
          </button>
          <button onClick={() => handleMethodSelect("otp")}>
            Mobile OTP Verification
          </button>
        </div>
      ) : (
        <div className="signature-container">
          <button onClick={() => setSignatureMethod("")}>
            ← Back to methods
          </button>
          ...
          {signatureMethod === "aadhaar" && (
            <div className="aadhaar-signature">
              ...
              <button onClick={handleAadhaarSignature}>
