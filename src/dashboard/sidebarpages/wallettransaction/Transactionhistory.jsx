...
import { FaCalendarAlt, FaSearch, FaFilter, FaDownload, FaAngleLeft, FaAngleRight, FaAngleDoubleLeft, FaAngleDoubleRight } from 'react-icons/fa';
...
const Transactionhistory = () => {
  ...
  const fetchTransactions = useCallback(async () => {
    ...
    try {
      ...
      const formattedTransactions = transactionsData.map(tx => ({
        ...
        serviceId: tx.serviceId && tx.serviceId.trim() !== '' ? tx.serviceId : 'N/A',
        referenceNo: tx.referenceNo && tx.referenceNo.trim() !== '' ? tx.referenceNo : 'N/A',
  ...
  const exportToCSV = async () => {
    ...
    try {
      ...
      console.error(error);
      toast.error(
        error.response?.data?.message || error.message || "Error exporting transactions"
      );
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="transaction-management">
      <div className="tm-header">
        ...
        <button className="tm-export-btn" onClick={exportToCSV} disabled={loading}>
            ...
            <div className="tm-table-wrapper">
              ...
              {currentTransactions.length > 0 && (
                <div className="tm-transaction-cards">
                  {currentTransactions.map((tx, index) => (
                    <div className="tm-transaction-card" key={`card-${tx._id || tx.id}`}>
