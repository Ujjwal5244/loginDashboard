      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
          <div className="bg-white bg-opacity-10 p-4 rounded-lg flex items-center">
            <FaCreditCard className="text-blue-400 mr-3" size={24} />
            <div>
          ...
          <div className="bg-white bg-opacity-10 p-4 rounded-lg flex items-center">
            <FaShieldAlt className="text-green-400 mr-3" size={24} />
            <div>
          ...
          <div className="bg-white bg-opacity-10 p-4 rounded-lg flex items-center">
            <FaHeadset className="text-purple-400 mr-3" size={24} />
            <div>
        ...
        <div className="border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} NifiPayment. All rights reserved.
          </p>
