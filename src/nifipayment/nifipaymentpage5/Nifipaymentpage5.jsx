...
const Nifipaymentpage5 = () => {
  ...
  return (
    <div className="bg-[#f4e8f8] min-h-[100%] flex flex-col items-center justify-center p-4  sm:p-8 font-sans">
      <h2 className='text-2xl font-bold mb-6'>Don’t take our word for it</h2>
      <p className="md:text-lg xs:text-sm px-6 text-gray-700 mb-12 text-center max-w-2xl">
        See how growth minded Indian companies are using Leegality to drive
        fantastic business results
      </p>
      {/* Main Card */}
      <div className="bg-[#f8f9fa] rounded-2xl shadow-lg overflow-hidden max-w-7xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 relative">
        {/* Navigation Arrows */}
        <button
          onClick={goToPrev}
...
export default Nifipaymentpage5;
